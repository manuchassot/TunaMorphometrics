...
IO_NUMBER_FISH_NO_OCEAN_INFORMATION = sum(IO_INDIC_NO_OCEAN_INFORMATION)
...
IO_NUMBER_FISH_NO_GEOMETRY = sum(IO_INDIC_NO_GEOMETRY)
...
AO_NUMBER_FISH_NO_OCEAN_INFORMATION = sum(AO_INDIC_NO_OCEAN_INFORMATION)
...
AO_NUMBER_FISH_NO_GEOMETRY = sum(AO_INDIC_NO_GEOMETRY)
