...
ggsave("../outputs/charts/FL_RW/FORK_LENGTH_ROUND_WEIGHT_FULL_DATA_SET_SCATTERPLOT.png", FORK_LENGTH_ROUND_WEIGHT_FULL_DATA_SET_SCATTERPLOT, width = 10, height = 4.5/8*10)
