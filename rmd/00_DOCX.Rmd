...
author: Chassot Emmanuel^1,2^, Nathalie Bodin^1,2,3^, Constance Diaha^4^, Cindy Assan^4^, Pedro Pascual-Alayón^5^, José-Carlos Báez^6,7^, Aurélie Guillou^1^, Julien Lebranchu^1^, Francis Marsac^1,\(^\dagger\)^
output:
  word_document2:
