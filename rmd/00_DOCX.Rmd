...
author: Chassot Emmanuel^1,2^, Nathalie Bodin^1,2,3^, Constance Diaha^4^, Cindy Assan^4^, Pedro Pascual-Alayón^5^, José-Carlos Báez^6,7^, Aurélie Guillou^1^, Antoine Duparc^1^, Francis Marsac^1^, Julien Barde^1^, and Julien Lebranchu^1,\(^\dagger\)^
output:
  word_document2:
...
```{r child = "07_TABLES.Rmd", eval = FALSE}
```

\pagebreak

```{r child = "08_FIGURES.Rmd", eval = FALSE}
```
