...
yellowfin tuna overall contribute to `r PERCENT_YFT`% of the total data set when skipjack and bigeye tunas represent `r PERCENT_SKJ`% and `r PERCENT_SKJ`%, respectively. For each species and ocean, the data well cover the range of sizes exploited in the purse seine fishery, from recruitment at about 30 cm _L~F~_ to sizes close to the maximum sizes observed for tropical tunas across all fisheries (ICCAT 2021, IOTC 2021).
