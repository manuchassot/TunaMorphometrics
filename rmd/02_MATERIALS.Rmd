...
For each fish, the species was identified based on meristic and morphometric traits and the sex determined from visual examination of the gonads [@Collette1983]. All fish from processing factories were defrosted prior to sampling for length and weight (**Table X**). Length measurements were taken with a calliper in most cases (XX% of the data set) and recorded to the nearest 0.1 cm while total weights were measured with a scale to the nearest 0.1 kg. Tuna collected during the IO-RTTP were sampled fresh at sea and measured with a measuring board while their total weight was measured with spring scales.
